...
class Crud{
    ...
    private function getRequete(int $type, array $property, string $dbname, string $name) : string
    {
        if($type === 0){//read ---------------------------------------------------
            ...
            $req = "'INSERT INTO " . $dbname . "(" . $property[0]->getName();
            ...
            $req = $req . ") VALUES (" . $property[0]->getName();
            ...
            $req = "'UPDATE " . $dbname . " SET " . $property[0]->getName() . " = :" . $property[0]->getName();
