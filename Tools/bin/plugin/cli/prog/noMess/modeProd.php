...
if(!is_null($comfirme)){
	$tabCopyFile = array(
			'context/Response-prod.php' => $api . 'vendor/NoMess/Response.php',
			'context/WorkException-prod.php' => $api . 'vendor/NoMess/WorkException.php',
			'context/index-prod.php' => '../index.php'
	);
